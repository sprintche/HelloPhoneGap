...
function updateAcceleration(a) {
	$('#x').innerHTML = roundNumber(a.x);
	$('#y').innerHTML = roundNumber(a.y);
	$('#z').innerHTML = roundNumber(a.z);
}
...
function dump_pic(data) {
	...
	$('#test_img').src = "data:image/jpeg;base64," + data;
}
